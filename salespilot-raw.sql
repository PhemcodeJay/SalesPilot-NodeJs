...
CREATE TABLE `activation_codes` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `activation_codes_ibfk_77` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `activation_codes_ibfk_78` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-05-07  3:42:43
